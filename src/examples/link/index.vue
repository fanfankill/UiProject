    ...
    >
      <template v-slot:showarea>
        <div class="block_show_div">
          <div class="link_col">
              <ct-link href="https://element.eleme.io" target="_blank">默认链接</ct-link>
      ...
      <template v-slot:showarea>
        <div class="block_show_div">
          <div class="link_col">
              ...
              <ct-link type="primary" disabled :underline="false">主要链接</ct-link>
              <ct-link type="success" disabled :underline="false">成功链接</ct-link>
              <ct-link type="warning" disabled :underline="false">警告链接</ct-link> 
              <ct-link type="danger" disabled :underline="false">危险链接</ct-link>
              <ct-link type="info" disabled :underline="false">信息链接</ct-link>
          </div>
        </div>
      </template>
      <template v-slot:desc>
       设置<code>disabled</code>、<code>underline</code>属性定义 Link 的禁用状态。
      </template>
    </showcomponent>
     <showcomponent
        title="下划线"
      ...
      <template v-slot:showarea>
        <div class="block_show_div">
          <div class="link_col">
              ...
              <ct-link>查看<i class="iconfont icon-check-line  el-icon--right"></i></ct-link>
          </div>
        </div>
      </template> 
    </showcomponent>
  ...
  data(){
    return{
      ...
      parameter:{
        ...
        ['inactive-value',	'switch 关闭时的值',	'boolean / string / number',	'—','true'],
