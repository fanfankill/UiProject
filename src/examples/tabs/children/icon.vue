<template>
   <showcomponent
    ...
    >
      <template #showarea>
        ...
        <ct-tabs type="card" @tabClick="handleClick">
          ...
          <ct-tab-pane label="上方" name="top">
            <ct-tabs class="ct-demo-box">
                <ct-tab-pane icon="iconfontapple-t" label="macOs" name="one">标签一的内容</ct-tab-pane>
                <ct-tab-pane icon="windows-fill-t" label="Windows" name="tow">标签二的内容</ct-tab-pane>
                <ct-tab-pane icon="linux-t" label="Linux" name="three">标签三的内容</ct-tab-pane>
              </ct-tabs>
          </ct-tab-pane>
          <ct-tab-pane label="右侧" name="right">
            <ct-tabs class="ct-demo-box">
                <ct-tab-pane icon="iconfontapple-r" label="macOs" name="one">标签一的内容</ct-tab-pane>
                <ct-tab-pane icon="windows-fill-r" label="Windows" name="tow">标签二的内容</ct-tab-pane>
                <ct-tab-pane icon="linux-r" label="Linux" name="three">标签三的内容</ct-tab-pane>
              </ct-tabs>
          </ct-tab-pane>
          <ct-tab-pane label="下方" name="bottom">
            <ct-tabs class="ct-demo-box">
                <ct-tab-pane icon="iconfontapple-b" label="macOs" name="one">标签一的内容</ct-tab-pane>
                <ct-tab-pane icon="windows-fill-b" label="Windows" name="tow">标签二的内容</ct-tab-pane>
                <ct-tab-pane icon="linux-b" label="Linux" name="three">标签三的内容</ct-tab-pane>
              </ct-tabs>
          </ct-tab-pane>
        </ct-tabs>
      ...
      <template #desc>
        <div>
          <code>icon</code>属性用于设置图标，最后一个" - "分隔的两部分前面的是图标名，后面的是图标位置。默认是在左面，即" l "，t、r、b分别表示上面、右面、下面。
        </div>
      </template>
    </showcomponent>
</template>
